...
private:
    ...
    static napi_value SetSilentModerAndMixWithOthers(napi_env env, napi_callback_info info);
    static napi_value GetSilentModerAndMixWithOthers(napi_env env, napi_callback_info info);
