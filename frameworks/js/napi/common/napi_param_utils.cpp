                                                   ...
                                                   napi_value in)
{
    ...
    uint32_t arrayLen = 0;
    napi_get_array_length(env, in, &arrayLen);
    CHECK_AND_RETURN_RET_LOG(arrayLen != 0, NAPI_ERR_INVALID_PARAM, "Get Audio Effect Property vector is NULL!");
    ...
    for (size_t i = 0; i < arrayLen; i++) {
        ...
        CHECK_AND_RETURN_RET_LOG(prop.effectClass != "", NAPI_ERR_INVALID_PARAM, "effectClass is empty");
        ...
        CHECK_AND_RETURN_RET_LOG(prop.effectProp != "", NAPI_ERR_INVALID_PARAM, "effectProp is empty");
                                                    ...
                                                    napi_value in)
{
    ...
    uint32_t arrayLen = 0;
    napi_get_array_length(env, in, &arrayLen);
    CHECK_AND_RETURN_RET_LOG(arrayLen != 0, NAPI_ERR_INVALID_PARAM, "Get Audio Enhance Property vector is NULL!");
    ...
    for (size_t i = 0; i < arrayLen; i++) {
        ...
        CHECK_AND_RETURN_RET_LOG(prop.enhanceClass != "", NAPI_ERR_INVALID_PARAM, "enhanceClass is empty");
        ...
        CHECK_AND_RETURN_RET_LOG(prop.enhanceProp != "", NAPI_ERR_INVALID_PARAM, "enhanceProp is empty");
                                               ...
                                               napi_value &result)
{
    ...
    for (const auto &property : enhanceArray.property) {
        ...
        CHECK_AND_RETURN_RET_LOG(prop.enhanceClass != "", NAPI_ERR_INVALID_PARAM, "enhanceClass is empty");
        SetValueString(env, "enhanceClass", property.enhanceClass, jsEnhanceInfoObj);
        CHECK_AND_RETURN_RET_LOG(prop.enhanceProp != "", NAPI_ERR_INVALID_PARAM, "enhanceProp is empty");
        SetValueString(env, "enhanceProp", property.enhanceProp, jsEnhanceInfoObj);
                                              ...
                                              napi_value &result)
{
    ...
    for (const auto &property : effectArray.property) {
        ...
        CHECK_AND_RETURN_RET_LOG(prop.effectClass != "", NAPI_ERR_INVALID_PARAM, "effectClass is empty");
        SetValueString(env, "effectClass", property.effectClass, jsEffectInfoObj);
        CHECK_AND_RETURN_RET_LOG(prop.effectProp != "", NAPI_ERR_INVALID_PARAM, "effectProp is empty");
        SetValueString(env, "effectProp", property.effectProp, jsEffectInfoObj);
