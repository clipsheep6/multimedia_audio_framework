...
AudioCapturerDeviceChangeCallbackNapi::AudioCapturerDeviceChangeCallbackNapi(napi_env env)
    : env_(env)
{
    AUDIO_INFO_LOG("AudioCapturerDeviceChangeCallbackNapi: instance create");
}

AudioCapturerDeviceChangeCallbackNapi::~AudioCapturerDeviceChangeCallbackNapi()
{
    AUDIO_INFO_LOG("AudioCapturerDeviceChangeCallbackNapi: instance destroy");
}
...
void AudioCapturerDeviceChangeCallbackNapi::SaveCallbackReference(napi_value args)
{
    ...
    callback_ = callback;
    AUDIO_INFO_LOG("SaveCallbackReference successful");
}
...
void AudioCapturerDeviceChangeCallbackNapi::WorkCallbackCompleted(uv_work_t *work, int status)
{
    ...
    if (event == nullptr || event->callback_ == nullptr) {
        AUDIO_ERR_LOG("AudioCapturerDeviceChangeJsCallback: OnJsCallbackCapturerDeviceInfo: No memory");
        return;
    }
    ...
    const DeviceInfo &deviceInfo)
{
    ...
    if (work == nullptr) {
        AUDIO_ERR_LOG("AudioCapturerDeviceChangeCallbackNapi: OnJsCallbackCapturerDeviceInfo: No memory");
    }
    ...
    AUDIO_ERR_LOG("OnJsCallbackCapturerDeviceInfo");
