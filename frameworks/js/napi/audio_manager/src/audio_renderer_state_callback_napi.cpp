...
void AudioRendererStateCallbackNapi::OnRendererStateChange(const std::vector<std::unique_ptr<AudioRendererChangeInfo>> &audioRendererChangeInfos)
{
    AUDIO_INFO_LOG("AudioRendererStateCallbackNapi: OnRendererStateChange is called");

    //CHECK_AND_RETURN_LOG(rendererChangeInfo != nullptr, "Cannot find the reference of renderer change callback");
    ...
    //cb->changeInfo = rendererChangeInfo;
    ...
    const vector<unique_ptr<AudioRendererChangeInfo>> &changeInfos)
{
    ...
    for (unique_ptr<AudioRendererChangeInfo> changeInfo: changeInfos) {
