...
#undef LOG_TAG
#define LOG_TAG "AudioCapturerSourceNormal"
...
static AudioFormat AudioCapturerSourceInner::ConvertToHdiFormat(HdiAdapterFormat format)
{
...
int32_t AudioCapturerSourceInner::SwitchAdapterCapture(struct AudioAdapterDescriptor *descs, uint32_t size,
