...
int32_t RemoteAudioCapturerSourceInner::SetVolume(float left, float right)
{
    ...
    AUDIO_DEBUG_LOG("remote setVolume(%{public}f, %{public}f):%{public}d", left, right, ret);
    return ret;
}
