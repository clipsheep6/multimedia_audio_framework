...
public:
    ...
    void SetRendererInfo(const AudioRendererInfo &rendererInfo, const std::shared_ptr<AudioClientTracker> &rendererProxyObj);
    void SetCapturerInfo(const AudioCapturerInfo &capturerInfo, const std::shared_ptr<AudioClientTracker> &rendererProxyObj);
