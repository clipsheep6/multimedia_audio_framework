...
/**
* @tc.name  : Test OH_AudioRenderer_SetInterruptMode API via legal state.
* @tc.number: OH_Audio_Render_SetInterruptMode_001
* @tc.desc  : Test OH_AudioRenderer_SetInterruptMode interface with nullptr audioRenderer.
*/
HWTEST(OHAudioRenderUnitTest, OH_Audio_Render_SetInterruptMode_001, TestSize.Level0)
{
    OH_AudioRenderer* audioRenderer = nullptr;

    OH_AudioStream_InterruptMode mode = AUDIOSTREAM_SHARE_MODE;
    OH_AudioStream_Result result = OH_AudioRenderer_SetInterruptMode(audioRenderer, mode);
    EXPECT_TRUE(result == AUDIOSTREAM_ERROR_INVALID_PARAM);
}

/**
* @tc.name  : Test OH_AudioRenderer_SetInterruptMode API via legal state.
* @tc.number: OH_Audio_Render_SetInterruptMode_002
* @tc.desc  : Test OH_AudioRenderer_SetInterruptMode interface with share mode.
*/
HWTEST(OHAudioRenderUnitTest, OH_Audio_Render_SetInterruptMode_002, TestSize.Level0)
{
    OH_AudioStreamBuilder* builder = OHAudioRenderUnitTest::CreateRenderBuilder();
    OH_AudioRenderer* audioRenderer;
    OH_AudioStream_Result result = OH_AudioStreamBuilder_GenerateRenderer(builder, &audioRenderer);
    ...
    OH_AudioStream_InterruptMode mode = AUDIOSTREAM_SHARE_MODE;
    result = OH_AudioRenderer_SetInterruptMode(audioRenderer, mode);
    EXPECT_TRUE(result == AUDIOSTREAM_SUCCESS);
    OH_AudioStreamBuilder_Destroy(builder);
}
...
/**
* @tc.name  : Test OH_AudioRenderer_SetInterruptMode API via legal state.
* @tc.number: OH_Audio_Render_SetInterruptMode_003
* @tc.desc  : Test OH_AudioRenderer_SetInterruptMode interface with independent mode.
*/
HWTEST(OHAudioRenderUnitTest, OH_Audio_Render_SetInterruptMode_003, TestSize.Level0)
{
    OH_AudioStreamBuilder* builder = OHAudioRenderUnitTest::CreateRenderBuilder();
    OH_AudioRenderer* audioRenderer;
    OH_AudioStream_Result result = OH_AudioStreamBuilder_GenerateRenderer(builder, &audioRenderer);

    OH_AudioStream_InterruptMode mode = AUDIOSTREAM_INDEPENDENT_MODE;
    result = OH_AudioRenderer_SetInterruptMode(audioRenderer, mode);
    EXPECT_TRUE(result == AUDIOSTREAM_SUCCESS);
    OH_AudioStreamBuilder_Destroy(builder);
}
