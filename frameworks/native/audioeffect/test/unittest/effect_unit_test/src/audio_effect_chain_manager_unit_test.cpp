...
/**
* @tc.name   : Test EffectVolumeUpdate API
* @tc.number : EffectVolumeUpdate_003
* @tc.desc   : Test EffectVolumeUpdate interface(using abnormal use case).
*              Test EffectDspVolumeUpdate and EffectApVolumeUpdate simultaneously.
*/
HWTEST(AudioEffectChainManagerUnitTest, EffectVolumeUpdate_003, TestSize.Level1)
{
    string sessionIDString = "123456";
    uint32_t volume = 123456;
...
/**
* @tc.name   : Test EffectVolumeUpdate API
* @tc.number : EffectVolumeUpdate_004
* @tc.desc   : Test EffectVolumeUpdate interface(using abnormal use case).
*              Test EffectDspVolumeUpdate and EffectApVolumeUpdate simultaneously.
*/
HWTEST(AudioEffectChainManagerUnitTest, EffectVolumeUpdate_004, TestSize.Level1)
{
    string sessionIDString = "123456";
    uint32_t volume = 123456;
