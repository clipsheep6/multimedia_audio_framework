...
public:
    ...
    int32_t GetVolumeGroupInfos(std::vector<sptr<VolumeGroupInfo>> &infos);

    int32_t GetVolumeGroupInfoByNetworkId(std::string networkId, std::vector<sptr<VolumeGroupInfo>> &infos);
