...
{
    AUDIO_INFO_LOG("AudioCapturerPrivate::SetCapturerPolicyServiceDiedCallback");
...
{
    AUDIO_INFO_LOG("AudioCapturerPrivate::RemoveCapturerPolicyServiceDiedCallback");
    if (audioPolicyServiceDiedCallback_) {
...
{
    AUDIO_INFO_LOG("CapturerPolicyServiceDiedCallback create");
}

CapturerPolicyServiceDiedCallback::~CapturerPolicyServiceDiedCallback()
{
    AUDIO_INFO_LOG("CapturerPolicyServiceDiedCallback destroy");
}
...
void CapturerPolicyServiceDiedCallback::OnAudioPolicyServiceDied()
{
    ...
    pthread_setname_np(restoreThread_->native_handle(), "audioCapturerRestore");
}
