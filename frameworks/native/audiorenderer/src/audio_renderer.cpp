...
{
    AUDIO_INFO_LOG("AudioRendererPrivate::RegisterRendererPolicyServiceDiedCallback");
...
{
    AUDIO_INFO_LOG("AudioRendererPrivate::RemoveRendererPolicyServiceDiedCallback");
    if (audioPolicyServiceDiedCallback_) {
...
{
    AUDIO_INFO_LOG("RendererPolicyServiceDiedCallback create");
}

RendererPolicyServiceDiedCallback::~RendererPolicyServiceDiedCallback()
{
    AUDIO_INFO_LOG("RendererPolicyServiceDiedCallback destroy");
}
...
void RendererPolicyServiceDiedCallback::OnAudioPolicyServiceDied()
{
    ...
    pthread_setname_np(restoreThread_->native_handle(), "audioRendererRestore");
}
