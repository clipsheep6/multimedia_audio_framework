...
/**
 * @tc.name  : Test toneplayer CheckToneContinuity API
 * @tc.type  : FUNC
 * @tc.number: Toneplayer_CheckToneContinuity_001
 * @tc.desc  : Test CheckToneContinuity interface.
 */
HWTEST(AudioToneplayerUnitTest, Toneplayer_CheckToneContinuity_001, TestSize.Level1)
{
    AudioRendererInfo rendererInfo = {};
    rendererInfo.contentType = ContentType::CONTENT_TYPE_MUSIC;
    rendererInfo.streamUsage = StreamUsage::STREAM_USAGE_DTMF;
    ...
    toneplayer->CheckToneContinuity();
