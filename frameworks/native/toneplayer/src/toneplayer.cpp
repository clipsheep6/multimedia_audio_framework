...
bool TonePlayerPrivate::InitAudioRenderer()
{
    ...
    CHECK_AND_RETURN_RET_LOG(audioRenderer_ != nullptr, false,
        "initAudioRenderer: Renderer create failed");
    ...
    CHECK_AND_RETURN_RET_LOG(!setRendererWrite, false, "initAudioRenderer: SetRendererWriteCallback failed");
    ...
    AUDIO_DEBUG_LOG("initAudioRenderer: SetVolume Sucessful");
    return true;
}
