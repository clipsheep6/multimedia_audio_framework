...
*/
HWTEST(AudioCapturerModuleTest, Audio_Capturer_SetParams_Stability_001, TestSize.Level1)
{
    int32_t ret = -1;
    unique_ptr<AudioCapturer> audioCapturer = AudioCapturer::Create(STREAM_MUSIC);
    ASSERT_NE(nullptr, audioCapturer);
...
*/
HWTEST(AudioCapturerModuleTest, Audio_Capturer_GetParams_Stability_001, TestSize.Level1)
{
    int32_t ret = -1;
    unique_ptr<AudioCapturer> audioCapturer = AudioCapturer::Create(STREAM_MUSIC);
    ASSERT_NE(nullptr, audioCapturer);
...
*/
HWTEST(AudioCapturerModuleTest, Audio_Capturer_GetAudioTime_Stability_001, TestSize.Level1)
{
    int32_t ret = -1;
    unique_ptr<AudioCapturer> audioCapturer = AudioCapturer::Create(STREAM_MUSIC);
    ASSERT_NE(nullptr, audioCapturer);
...
*/
HWTEST(AudioCapturerModuleTest, Audio_Capturer_Flush_Stability_001, TestSize.Level1)
{
    int32_t ret = -1;
    unique_ptr<AudioCapturer> audioCapturer = AudioCapturer::Create(STREAM_MUSIC);
    ASSERT_NE(nullptr, audioCapturer);
