...
public:
    ...
    void AddComRenderPrivacyDev(const AudioDeviceDescriptor &devDesc);

    void AddComRenderPublicDev(const AudioDeviceDescriptor &devDesc);

    void AddComCapturePrivacyDev(const AudioDeviceDescriptor &devDesc);

    void AddComCapturePublicDev(const AudioDeviceDescriptor &devDesc);

    void AddCapPrivacyDev(const AudioDeviceDescriptor &devDesc);

    void AddCapPublicDev(const AudioDeviceDescriptor &devDesc);

    void AddMediaRenderPrivcayDev(const AudioDeviceDescriptor &devDesc);

    void AddMediaRenderPublicDev(const AudioDeviceDescriptor &devDesc);

    void AddMediaCapturePrivacyDev(const AudioDeviceDescriptor &devDesc);

    void AddMediaCapturePublicDev(const AudioDeviceDescriptor &devDesc);
    ...
    std::vector<unique_ptr<AudioDeviceDescriptor>> &GetMediaRenderPrivacyDevices();

    std::vector<unique_ptr<AudioDeviceDescriptor>> &GetMediaRenderPublicDevices();

    std::vector<unique_ptr<AudioDeviceDescriptor>> &GetMediaCapturePrivacyDevices();

    std::vector<unique_ptr<AudioDeviceDescriptor>> &GetMediaCapturePublicDevices();
...
private:
    ...
    // 私有媒体播放设备
    std::vector<unique_ptr<AudioDeviceDescriptor>> mediaRenderPrivacyDevices_;
    // 公共媒体播放设备
    std::vector<unique_ptr<AudioDeviceDescriptor>> mediaRenderPublicDevices_;
    // 私有媒体录制设备
    std::vector<unique_ptr<AudioDeviceDescriptor>> mediaCapturePrivacyDevices_;
    // 公共媒体录制设备
    std::vector<unique_ptr<AudioDeviceDescriptor>> mediaCapturePublicDevices_;
    // 私有录制设备
