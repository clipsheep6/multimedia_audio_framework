...
public:
    ...
    AudioStrategyRouterParser():audioRouterCenter_(AudioRouterCenter::GetAudioRouterCenter())
    {
         AUDIO_INFO_LOG("AudioStrategyRouterParser ctor");
    }

    ~AudioStrategyRouterParser()
    {
        AUDIO_INFO_LOG("AudioStrategyRouterParser dtor");
        Destroy();
    }
...
private:
    ...
    void ParserMediaRenderRouters(const std::string &routers);
    void ParserRecordCaptureRouters(const std::string &routers);
    void ParserCallRenderRouters(const std::string &routers);
    void ParserCallCaptureRouters(const std::string &routers);
    void ParserRingRenderRouters(const std::string &routers);
    void ParserToneRenderRouters(const std::string &routers);
