...
private:
    ...
    int32_t SetRendererStateChangeCallback(const sptr<IRemoteObject> &object);
    int32_t SetCapturerStateChangeCallback(const sptr<IRemoteObject> &object);
    
    void UpdateRendererDeviceInfo(const std::vector<std::unique_ptr<AudioRendererChangeInfo>> &rendererChangeInfos);
    void UpdateCapturerDeviceInfo(const std::vector<std::unique_ptr<AudioCapturerChangeInfo>> &capturerChangeInfos);
    ...
    static inline HandlerFunc handlers[] = {
        ...
        &AudioPolicyClientProxy::SetRendererStateChangeCallback,
        &AudioPolicyClientProxy::SetCapturerStateChangeCallback,
    };
    ...
    std::vector<std::shared_ptr<AudioRendererStateChangeCallback>> rendererStateChangeCbList_;
    std::vector<std::shared_ptr<AudioCapturerStateChangeCallback>> capturerStateChangeCbList_;
};
} // namespace AudioStandard
} // namespace OHOS
