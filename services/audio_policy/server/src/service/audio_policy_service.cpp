...
void AudioPolicyService::OnPerferStateUpdated(AudioDeviceDescriptor &desc, const DeviceInfoUpdateCommand updateCommand)
{
...
void AudioPolicyService::OnDeviceInfoUpdated(AudioDeviceDescriptor &desc, const DeviceInfoUpdateCommand updateCommand)
{
    ...
    OnPerferStateUpdated(desc, updateCommand);
    FetchDevice(false);
    UpdateA2dpOffloadFlagForAllStream();
}
