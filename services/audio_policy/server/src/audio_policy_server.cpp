...
void AudioPolicyServer::RegisterPowerStateListener()
{
    ...
    if (powerStateListener_ == nullptr) {
        AUDIO_ERR_LOG("AudioPolicyServer create power state listener failed");
        return;
    }
    ...
    if (!ret) {
        AUDIO_ERR_LOG("AudioPolicyServer register sync sleep callback failed");
    } else {
        AUDIO_INFO_LOG("AudioPolicyServer register sync sleep callback success");
    }
}
...
{
    if (powerStateListener_ == nullptr) {
        AUDIO_ERR_LOG("AudioPolicyServer power state listener is null");
        return;
    }
    ...
    if (!ret) {
        AUDIO_ERR_LOG("AudioPolicyServer unregister sync sleep callback failed");
    } else {
        powerStateListener_ = nullptr;
        AUDIO_INFO_LOG("AudioPolicyServer unregister sync sleep callback success");
    }
}
} // namespace AudioStandard
} // namespace OHOS
