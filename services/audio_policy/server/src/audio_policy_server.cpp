    ...
    sptr<AudioRendererFilter> audioRendererFilter)
{
    ...
    std::vector<sptr<AudioDeviceDescriptor>> deviceDescs = audioPolicyService_.GetOutputDevice(deviceFlag);
    ...
    sptr<AudioCapturerFilter> audioCapturerFilter)
{
    ...
    std::vector<sptr<AudioDeviceDescriptor>> deviceDescs = audioPolicyService_.GetInputDevice(deviceFlag);
