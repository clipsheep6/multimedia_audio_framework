...
int32_t AudioPolicyServer::ConfigDistributedRoutingRole(AudioDeviceDescriptor *descriptor, Casttype type)
{
...
int32_t AudioPolicyServer::SetDistributedRoutingRoleCallback(int32_t /*clientId*/,
        const sptr<IRemoteObject> &object)
{
...
int32_t AudioPolicyServer::UnsetDistributedRoutingRoleCallback(const int32_t /*clientId*/)
{
    std::lock_guard<std::mutex> lock(configDistributedRoutingMutex_);
    int32_t clientPid = IPCSkeleton::GetCallingPid();
    AUDIO_INFO_LOG("Entered %{public}s", __func__);
...
void AudioPolicyServer::OnDistributedRoutingRoleChange(const AudioDeviceDescriptor *descriptor, const CastType type)
{
    std::lock_guard<std::mutex> lock(configDistributedRoutingMutex_);
    AUDIO_INFO_LOG("Entered %{public}s", __func__);
