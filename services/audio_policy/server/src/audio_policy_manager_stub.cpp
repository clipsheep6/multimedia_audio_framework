...
void AudioPolicyManagerStub::ConfigDistributedRoutingRole(MessageParcel &data, MessageParcel &reply)
{
...
void AudioPolicyManagerStub::SetDistributedRoutingRoleCallback(MessageParcel &data, MessageParcel &reply)
{
    int32_t clientId = data.ReadInt32();
    sptr<IRemoteObject> object = data.ReadRemoteObject();
    if (object == nullptr) {
...
void AudioPolicyManagerStub::UnsetDistributedRoutingRoleCallback(MessageParcel &data, MessageParcel &reply)
{
    int32_t clientId = data.ReadInt32();
