...
enum class AudioPolicyInterfaceCode {
    ...
    IS_MICROPHONE_MUTE,
    REGISTER_RINGERMODE_CALLBACK,
    UNREGISTER_RINGERMODE_CALLBACK,
    REGISTER_AUDIO_INTERRUPT_CALLBACK,
    UNREGISTER_AUDIO_INTERRUPT_CALLBACK,
    ACTIVATE_INTERRUPT,
    DEACTIVATE_INTERRUPT,
    REGISTER_AUDIO_MANAGER_INTERRUPT_CB,
    UNREGISTER_AUDIO_MANAGER_INTERRUPT_CB,
    REQUEST_AUDIO_FOCUS,
    ABANDON_AUDIO_FOCUS,
    GET_STREAM_IN_FOCUS,
    ...
    REGISTER_MIC_STATE_CHANGE_CALLBACK,
    UNREGISTER_MIC_STATE_CHANGE_CALLBACK,
