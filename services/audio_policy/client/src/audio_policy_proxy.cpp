...
int32_t AudioPolicyProxy::ConfigDistributedRoutingRole(AudioDeviceDescriptor *descriptor, CastType type)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::SetDistributedRoutingRoleCallback(const int32_t clientId, const sptr<IRemoteObject> &object)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::UnsetDistributedRoutingRoleCallback(const int32_t clientId)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    ...
    token = data.WriteInt32(clientId);
    ...
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, error, "AudioPolicyProxy UnsetDistributedRoutingRoleCallback failed error : %{public}d", error);
    return reply.ReadInt32();
}
