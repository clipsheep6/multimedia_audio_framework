...
int32_t AudioPolicyProxy::RegisterAudioInterruptCallbackClient(const sptr<IRemoteObject>& object, const uint32_t sessionID,
        const uint32_t code)
{
    MessageParcel data;
    MessageParcel reply;
...
int32_t AudioPolicyProxy::RegisterPolicyCallbackClient(const sptr<IRemoteObject> &object, const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::UnregisterPolicyCallbackClient(const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
