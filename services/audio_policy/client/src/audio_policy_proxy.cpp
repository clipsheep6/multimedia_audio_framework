...
int32_t AudioPolicyProxy::RegisterPreferredOutputDeviceChangeCbClient(const sptr<IRemoteObject> &object,
    const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
...
int32_t AudioPolicyProxy::RegisterPreferredInputDeviceChangeCbClient(const sptr<IRemoteObject> &object,
        const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
...
int32_t AudioPolicyProxy::UnRegisterPreferredOutputDeviceChangeCbClient(const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::UnregisterPreferredInputDeviceChangeCbClient(const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::RegisterAudioManagerInterruptCallbackClient(const sptr<IRemoteObject> &object,
    const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    ...
    if (object == nullptr) {
        AUDIO_ERR_LOG("AudioPolicyProxy: RegisterAudioManagerInterruptCallbackClient object is null");
        return ERR_NULL_OBJECT;
    }
    if (!data.WriteInterfaceToken(GetDescriptor())) {
        AUDIO_ERR_LOG("AudioPolicyProxy: WriteInterfaceToken failed");
    ...
    (void)data.WriteRemoteObject(object);
    int error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioPolicyInterfaceCode::REGISTER_AUDIO_MANAGER_INTERRUPT_CB), data, reply, option);
    if (error != ERR_NONE) {
...
int32_t AudioPolicyProxy::UnregisterAudioManagerInterruptCallbackClient(const int32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
    ...
    data.WriteInt32(code);
    int error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioPolicyInterfaceCode::UNREGISTER_AUDIO_MANAGER_INTERRUPT_CB), data, reply, option);
    if (error != ERR_NONE) {
