...
int32_t AudioPolicyProxy::RegisterPolicyCallbackClient(const sptr<IRemoteObject> &object, const uint32_t code,
    API_VERSION api_v)
{
    MessageParcel data;
    MessageParcel reply;
...
int32_t AudioPolicyProxy::UnregisterPolicyCallbackClient(const uint32_t code)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
