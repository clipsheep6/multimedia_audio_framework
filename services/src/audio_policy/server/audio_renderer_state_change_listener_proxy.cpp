...
{
    AUDIO_INFO_LOG("AudioRendererStateChangeListenerProxy WriteRendererChangeInfo %{public}d",
...
void AudioRendererStateChangeListenerProxy::OnRendererStateChange(const vector<unique_ptr<AudioRendererChangeInfo>> &audioRendererChangeInfos)
{
    MessageParcel data;
    MessageParcel reply;
...
void AudioRendererStateChangeListenerCallback::OnRendererStateChange(const vector<unique_ptr<AudioRendererChangeInfo>> &audioRendererChangeInfos)
{
