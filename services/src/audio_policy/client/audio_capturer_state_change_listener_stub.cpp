...
void AudioCapturerStateChangeListenerStub::ReadAudioCapturerChangeInfo(MessageParcel &data, unique_ptr<AudioCapturerChangeInfo> &capturerChangeInfo)
{
    AUDIO_DEBUG_LOG("AudioCapturerStateChangeListenerStub: Deserializing");
...
void AudioCapturerStateChangeListenerStub::OnCapturerStateChange(const vector<unique_ptr<AudioCapturerChangeInfo>> &audioCapturerChangeInfos)
{
    //AUDIO_DEBUG_LOG("AudioCapturerStateChangeListenerStub: Deserializing");
    //unique_ptr<AudioCapturerChangeInfo> capturerChangeInfo = make_unique<AudioCapturerChangeInfo>();
    //CHECK_AND_RETURN_LOG(capturerChangeInfo != nullptr, "No memory!!");
    ...
    if (cb != nullptr) {
        //cb->OnCapturerStateChange(capturerChangeInfo);
    } else {
