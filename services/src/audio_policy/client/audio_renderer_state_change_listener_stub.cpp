...
void AudioRendererStateChangeListenerStub::ReadAudioRendererChangeInfo(MessageParcel &data, unique_ptr<AudioRendererChangeInfo> &rendererChangeInfo)
{
...
void AudioRendererStateChangeListenerStub::OnRendererStateChange(const vector<unique_ptr<AudioRendererChangeInfo>> &audioRendererChangeInfos)
{
    //AUDIO_DEBUG_LOG("AudioRendererStateChangeListenerStub: Deserializing");
    //unique_ptr<AudioRendererChangeInfo> rendererChangeInfo = make_unique<AudioRendererChangeInfo>();
    //CHECK_AND_RETURN_LOG(rendererChangeInfo != nullptr, "No memory!!");

    //AudioRendererChangeInfo rendererChangeInfo;
