...
int32_t AudioPolicyProxy::RegisterTracker(AudioMode &mode, AudioStreamChangeInfo &streamChangeInfo, const sptr<IRemoteObject> &object)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
void AudioPolicyProxy::ReadAudioRendererChangeInfo(MessageParcel &reply, unique_ptr<AudioRendererChangeInfo> &rendererChangeInfo)
{
...
void AudioPolicyProxy::ReadAudioCapturerChangeInfo(MessageParcel &reply, unique_ptr<AudioCapturerChangeInfo> &capturerChangeInfo)
{
...
int32_t AudioPolicyProxy::GetCurrentRendererChangeInfos(vector<unique_ptr<AudioRendererChangeInfo>> &audioRendererChangeInfos)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
...
int32_t AudioPolicyProxy::GetCurrentCapturerChangeInfos(vector<unique_ptr<AudioCapturerChangeInfo>> &audioCapturerChangeInfos)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
