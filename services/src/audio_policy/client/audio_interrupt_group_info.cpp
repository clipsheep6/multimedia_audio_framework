...
InterruptGroupInfo::InterruptGroupInfo(int32_t interruptGroupId, int32_t mappingId, std::string groupName, std::string networkId,
        ConnectType type)
    : interruptGroupId_(interruptGroupId), mappingId_(mappingId), groupName_(groupName), networkId_(networkId),
    connectType_(type)
{}
...
{
    return parcel.WriteInt32(interruptGroupId_) 
