...
int main(int argc, char *argv[])
{
    ...
    MEDIA_INFO_LOG("AudioVoIPTest: renderer test path = %{public}s", argv[AudioTestConstants::ARGS_INDEX_RENDERER_TEST_PATH]);
    MEDIA_INFO_LOG("AudioVoIPTest: capturer test path = %{public}s", argv[AudioTestConstants::ARGS_INDEX_CAPTURER_TEST_PATH]);

    /*AudioVoIPTest *renderTestObj = new AudioVoIPTest();
    std::thread renderThread(&AudioVoIPTest::TestPlayback, renderTestObj, argv[AudioTestConstants::ARGS_INDEX_RENDERER_TEST_PATH]);*/

    AudioVoIPTest *captureTestObj = new AudioVoIPTest();
    std::thread captureThread(&AudioVoIPTest::TestRecording, captureTestObj, argv[AudioTestConstants::ARGS_INDEX_CAPTURER_TEST_PATH]);
