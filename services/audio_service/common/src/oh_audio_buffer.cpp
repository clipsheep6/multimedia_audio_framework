...
int32_t OHAudioBuffer::WriteToParcel(const std::shared_ptr<OHAudioBuffer> &buffer, MessageParcel &parcel)
{
    ...
    if (bufferHolder != AudioBufferHolder::AUDIO_SERVER_SHARED && bufferHolder != AudioBufferHolder::AUDIO_SERVER_INDEPENDENT) {
...
std::shared_ptr<OHAudioBuffer> OHAudioBuffer::ReadFromParcel(MessageParcel &parcel)
{
    ...
    bufferHolder = bufferHolder == AudioBufferHolder::AUDIO_SERVER_SHARED ? AudioBufferHolder::AUDIO_CLIENT : bufferHolder;
