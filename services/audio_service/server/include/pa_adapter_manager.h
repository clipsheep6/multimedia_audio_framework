...
private:
    ...
    int32_t SetStreamAudioEnhanceMode(pa_stream *paStream, AudioEnhanceMode audioEnhanceMode);
    const std::string GetEnhanceModeName(AudioEnhanceMode audioEnhanceMode);
    ...
    AudioEnhanceMode enhanceMode_ = ENHANCE_NONE;
