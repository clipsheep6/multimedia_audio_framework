...
AudioDeviceDescriptor::AudioDeviceDescriptor(const AudioDeviceDescriptor &deviceDescriptor)
{
    ...
    networkName_ = deviceDescriptor.networkName_;
}
...
bool AudioDeviceDescriptor::Marshalling(Parcel &parcel) const
{
    ...
    parcel.WriteString(networkName_);
    return true;
}
...
sptr<AudioDeviceDescriptor> AudioDeviceDescriptor::Unmarshalling(Parcel &in)
{
    ...
    audioDeviceDescriptor->networkName_ = in.ReadString();

    return audioDeviceDescriptor;
}

void AudioDeviceDescriptor::SetDeviceInfo(std::string deviceName, std::string macAddress, std::string networkName)
{
