...
map<pair<ContentType, StreamUsage>, AudioStreamType> AudioStream::CreateStreamMap()
{
    ...
    streamMap[make_pair(CONTENT_TYPE_SPEECH, STREAM_USAGE_ASSISTANCE_ACCESSIBILITY)] = STREAM_ACCESSIBILITY;
    ...
    streamMap[make_pair(CONTENT_TYPE_SONIFICATION, STREAM_USAGE_ALARM)] = STREAM_ALARM;
