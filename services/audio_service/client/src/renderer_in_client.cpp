...
{
    AUDIO_INFO_LOG("jss SetRendererInfo");
    ...
    AUDIO_INFO_LOG("jss samplingRate: %{public}d, format: %{public}d, channelLayout: %{public}llu,", 
        rendererInfo_.samplingRate, rendererInfo_.format,rendererInfo_.channelLayout);
    if (GetOffloadEnable()) {
...
void RendererInClientInner::RegisterTracker(const std::shared_ptr<AudioClientTracker> &proxyObj)
{
    if (audioStreamTracker_ && audioStreamTracker_.get() && !streamTrackerRegistered_) {
        ...
        rendererInfo_.channelLayout = static_cast<AudioChannelLayout>(curStreamParams_.channelLayout);
        AUDIO_INFO_LOG("jss  samplingRate: %{public}d, format: %{public}d, channelLayout: %{public}llu,", 
        rendererInfo_.samplingRate, rendererInfo_.format,rendererInfo_.channelLayout);
