...
int32_t AudioManagerProxy::SetAsrAecMode(AsrAecMode asrAecMode)
{
    ...
    int32_t error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioServerInterfaceCode::SET_ASR_AEC_MODE), data, reply, option);//ö��ֵ��Ӧ��
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, false, "SetAudioScene failed,error:%d", error);
    int32_t result = reply.ReadInt32();
    return result;
}
...
int32_t AudioManagerProxy::GetAsrAecMode(AsrAecMode& asrAecMode)
{
    ...
    int32_t error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioServerInterfaceCode::GET_ASR_AEC_MODE), data, reply, option);//ö��ֵ��Ӧ��
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, false, "SetAudioScene failed,error:%d", error);
    int32_t result = reply.ReadInt32();
    return result;
}
...
int32_t AudioManagerProxy::SetAsrNoiseSuppressionMode(AsrNoiseSuppressionMode asrNoiseSuppressionMode)
{
    ...
    int32_t error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioServerInterfaceCode::SET_ASR_NOISE_SUPPRESSION_MODE), data, reply, option);//ö��ֵ��Ӧ��
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, false, "SetAudioScene failed,error:%d", error);
    int32_t result = reply.ReadInt32();
    return result;
}
...
int32_t AudioManagerProxy::GetAsrNoiseSuppressionMode(AsrNoiseSuppressionMode& asrNoiseSuppressionMode)
{
    ...
    int32_t error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioServerInterfaceCode::GET_ASR_NOISE_SUPPRESSION_MODE), data, reply, option);//ö��ֵ��Ӧ��
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, false, "SetAudioScene failed,error:%d", error);
    int32_t result = reply.ReadInt32();
    return result;
}
...
int32_t AudioManagerProxy::IsWhispering()
{
    ...
    int32_t error = Remote()->SendRequest(
        static_cast<uint32_t>(AudioServerInterfaceCode::IS_WHISPERING), data, reply, option);//ö��ֵ��Ӧ��
    CHECK_AND_RETURN_RET_LOG(error == ERR_NONE, false, "SetAudioScene failed,error:%d", error);
    int32_t result = reply.ReadInt32();
    return result;
}
