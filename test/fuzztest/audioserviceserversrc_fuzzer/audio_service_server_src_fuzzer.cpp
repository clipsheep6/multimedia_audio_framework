...
{   
    ...
    uint64_t id = 2;
    audioEndpoint = std::make_shared<AudioEndpointSeparate>(AudioEndpoint::EndpointType::TYPE_INDEPENDENT, id, STREAM_DEFAULT);
    AudioProcessConfig config = InitProcessConfig();
    ...
    std::shared_ptr<OHAudioBuffer> oHAudioBuffer = OHAudioBuffer::CreateFromLocal(totalSizeInFrame, spanSizeInFrame, byteSizePerFrame);
